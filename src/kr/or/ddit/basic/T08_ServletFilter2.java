...
public class T08_ServletFilter2 implements Filter { // Filter는 extends가 아닌 implements
/*
	ServletFilter
...
*/
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain fc) // filter가 여러개 묶여 있는 것을 filter Chain 이라고 한다.
		...
		System.out.println("T08_ServletFilter2 시작");
		...
		System.out.println("T08_ServletFilter2 완료");
	}
